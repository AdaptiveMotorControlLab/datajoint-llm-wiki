...
- [What Happens When a Worker Crashes with reserve_jobs=True](syntheses/worker-crash-recovery.md) — stale_timeout, job states, manual recovery, errors vs. crashes
